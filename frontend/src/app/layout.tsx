...
export const metadata = {
  title: 'GPUBROKER - AI-Powered GPU Marketplace',
  description: 'Find and compare GPU offers from multiple providers with real-time pricing and AI recommendations',
}
