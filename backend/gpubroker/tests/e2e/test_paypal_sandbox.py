...
class TestPayPalSandboxIntegration:
    ...
    def test_create_paypal_order(self, page: Page):
        ...
        assert result.get('success') == True, f"Order creation failed: {result.get('error')}"
    ...
    def test_paypal_approval_url_valid(self, page: Page):
        ...
        if result.get('success'):
            ...
            print(f"✅ PayPal approval URL is valid")
            print(f"   URL contains sandbox domain: ✓")
            print(f"   URL contains token: ✓")
        else:
    ...
    def test_full_paypal_payment_flow(self, page: Page):
        ...
        try:
            ...
            if email_field.is_visible(timeout=10000):
                ...
                print("⚠️ Email field not found - PayPal page structure may have changed")
