...
SUBNETS = os.getenv(
    "ECS_SUBNETS", 
    "subnet-04cc7be08489369a0,subnet-01aa30d4017fc910b"
).split(",")
                                    ...
                                    for detail in att.get("details", []):
                                        if detail["name"] == "networkInterfaceId":
                                            ...
                                            if ec2:
                                                ...
                                                for ni in eni.get("NetworkInterfaces", []):
                                                    metrics["public_ip"] = (
                                                        ni.get("Association", {}).get("PublicIp")
                                                    )
                                                    metrics["private_ip"] = ni.get("PrivateIpAddress")
                            break
