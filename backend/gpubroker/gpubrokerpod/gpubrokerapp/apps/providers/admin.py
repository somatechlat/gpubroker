...
from .models import GPUOffer, PriceHistory, Provider, KPICalculation, ProviderHealthCheck
...
class ProviderAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'name', 'display_name', 'status', 'reliability_score', 'created_at'
    )
    list_filter = ('status',)
...
class GPUOfferAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'gpu_type', 'provider', 'price_per_hour', 'gpu_memory_gb', 
        'region', 'availability_status', 'updated_at'
    )
    ...
    fieldsets = (
        ...
        ('Specifications', {'fields': ('gpu_memory_gb', 'cpu_cores', 'ram_gb', 'storage_gb', 'storage_type')}),
        ('Pricing', {'fields': ('price_per_hour', 'currency', 'spot_pricing', 'preemptible')}),
        ('Location', {'fields': ('region', 'availability_zone')}),
        ('Availability', {'fields': ('availability_status', 'min_rental_time', 'max_rental_time')}),
