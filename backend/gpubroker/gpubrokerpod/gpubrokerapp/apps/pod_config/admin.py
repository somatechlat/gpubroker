...
class PodConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("Mode & Status", {"fields": ["mode", "status", "last_mode_switch"]}),
        ("AWS Configuration", {"fields": ["aws_region", "aws_account_id"]}),
        (
            "Feature Flags",
        ...
        ("Billing", {"fields": ["markup_percentage"]}),
        (
            "Timestamps",
...
class PodParameterAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Identification", {"fields": ["id", "pod", "key", "description"]}),
        ("Values", {"fields": ["sandbox_value", "live_value", "default_value"]}),
        (
            "Type & Validation",
            {
                "fields": [
        ...
        ("AWS Integration", {"fields": ["aws_parameter_arn"], "classes": ["collapse"]}),
        (
            "Timestamps",
            {"fields": ["created_at", "updated_at"], "classes": ["collapse"]},
        ),
