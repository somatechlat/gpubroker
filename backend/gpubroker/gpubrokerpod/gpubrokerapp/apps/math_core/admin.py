...
class GPUBenchmarkAdmin(admin.ModelAdmin):
    ...
    list_display = (
        'gpu_model', 'tflops_fp32', 'tflops_fp16', 'vram_gb',
        'memory_bandwidth_gbps', 'source', 'verified_at'
    )
    ...
    fieldsets = (
        ...
        ('LLM Performance', {
            'fields': ('tokens_per_second_7b', 'tokens_per_second_13b', 'tokens_per_second_70b'),
