...
from .models import AuditLog, User, UserSession, APIKey, UserPreference, SavedSearch
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = (
        'email', 'full_name', 'organization', 'is_active', 'is_staff', 'created_at'
    )
...
class APIKeyAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'user', 'last_used_at', 'expires_at', 'created_at', 'revoked_at')
    list_filter = ('created_at', 'revoked_at')
