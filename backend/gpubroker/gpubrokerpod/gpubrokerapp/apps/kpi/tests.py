...
from gpubrokerpod.gpubrokerapp.apps.kpi.services import KPIEngine, get_kpi_overview, get_gpu_metrics, get_provider_kpis, get_market_insights
...
class TestKPIAPI:
    ...
    @pytest.mark.asyncio
    async def test_provider_kpis_endpoint(self, api_client, test_gpu_offers, test_provider):
