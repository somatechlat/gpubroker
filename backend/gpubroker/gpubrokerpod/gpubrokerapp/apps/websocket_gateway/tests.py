...
from gpubrokerpod.gpubrokerapp.apps.websocket_gateway.consumers import (
...
class TestPriceUpdateConsumer:
    ...
    async def test_connect_success(self):
        ...
        communicator = WebsocketCommunicator(PriceUpdateConsumer.as_asgi(), "/ws/")
...
class TestRedisSubscriber:
    ...
    async def test_subscriber_initialization(self):
        ...
        from gpubrokerpod.gpubrokerapp.apps.websocket_gateway.services import (
            RedisSubscriber,
        )
    ...
    async def test_subscriber_handles_message(self):
        ...
        message = {
            "type": "message",
            "data": json.dumps({"provider": "test", "price": 1.50}).encode(),
        }
