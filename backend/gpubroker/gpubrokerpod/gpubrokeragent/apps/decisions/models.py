...
class DecisionFeedback(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    decision = models.ForeignKey(AgentDecision, on_delete=models.CASCADE, related_name='feedback')
    ...
    usefulness_rating = models.IntegerField(choices=Rating.choices, blank=True, null=True)
