...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Plain text value (for non-sensitive data)",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether this is a secret (uses encrypted_value)",
                    ),
                ),
                (
                    "description",
            ...
            fields=[
                ...
                (
                    ...
                    encrypted_model_fields.fields.EncryptedCharField(
                        help_text="Encrypted database password", max_length=255
                    ),
                ),
                (
                    "conn_max_age",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    encrypted_model_fields.fields.EncryptedCharField(
                        blank=True,
                        help_text="Encrypted Redis password",
                        max_length=255,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    encrypted_model_fields.fields.EncryptedTextField(
                        blank=True,
                        help_text="Encrypted API secret (if required)",
                        null=True,
                    ),
                ),
                (
                    "endpoint_url",
                    models.URLField(
                        blank=True, help_text="Service endpoint URL", null=True
                    ),
                ),
                (
                    "config_json",
                    models.JSONField(
                        default=dict,
                        help_text="Additional service-specific configuration",
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["key", "is_active"], name="configurati_key_b8f4e7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="configuration",
            index=models.Index(
                fields=["category", "is_active"], name="configurati_categor_c5e8a9_idx"
            ),
        ),
    ]
